...
BB_ENV_PASSTHROUGH_ADDITIONS="$BB_ENV_PASSTHROUGH_ADDITIONS REPO_ROOT USER_SSTATE_DIR USER_DL_DIR USER_BB_NUMBER_THREADS USER_PARALLEL_MAKE NETWORK_SSID NETWORK_PASSWORD" \
    REPO_ROOT=$REPO_ROOT \
